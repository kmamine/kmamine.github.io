---
layout: post
title: "HeReFaNMi: Health-Related Fake News Mitigation"
date: 2024-04-01
...
This connects to my broader work in NLP and applied machine learning. Building classifiers for a sensitive, real-world domain is a useful reminder that model behavior has to be evaluated with the downstream consequences in mind, not only benchmark numbers.

## Links

- GitHub: [kmamine/HeReFaNMi](https://github.com/kmamine/HeReFaNMi)
